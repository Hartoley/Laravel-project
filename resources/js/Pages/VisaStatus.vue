<template>
    <div class="min-h-screen flex flex-col bg-gray-50">
        ...
        <div class="min-h-[100vh] flex-1 flex items-center justify-center relative">
            ...
            <div v-else class="w-full max-w-5xl px-4 py-10 overflow-y-auto">
                ...
                <div v-if="visApplicants.length > 0" class="overflow-hidden rounded-lg shadow-lg">
                    <table class="table-auto w-full bg-white border border-gray-300 rounded-lg">
                        <thead class="bg-gradient-to-r from-indigo-500 to-blue-500 text-white">
                            <tr>
                                <th class="py-4 px-6 text-left text-sm font-semibold uppercase">
                                    Full Name
                                </th>
                                <th class="py-4 px-6 text-left text-sm font-semibold uppercase">
                                    Status
                        ...
                        <tbody>
                            <tr v-for="(item, index) in visApplicants" :key="index"
                                ...
                                <td class="py-4 px-6 text-gray-600 capitalize">
                                    <span class="py-1 px-3 rounded-full text-xs font-medium" :class="{
                                ...
                                <td class="py-4 px-6">
                                    <button v-if="item.status === 'Accepted'" class="text-blue-500 hover:underline"
                                        @click="downloadVisa(item)">
                                        Download Proof
                                    </button>
                                    <button v-if="item.status === 'Pending'" class="text-yellow-500 hover:underline"
                                        @click="contactSupport(item)">
                                        Contact Support
                                    </button>
                                    <button v-if="item.status === 'Rejected'" class="text-red-500 hover:underline"
                                        @click="reapply(item)">
                                        Reapply
                                    </button>
                                </td>
                ...
                <div v-else class="text-center text-gray-500 font-semibold py-20">
                    No visa applications found.
                </div>
            </div>
        </div>

        <div v-if="downloadingVisa" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div class="bg-white w-[90%] md:w-[50%] p-6 rounded-lg shadow-lg relative">
                <button @click="closeDownloadModal" class="absolute top-3 right-3 text-gray-500 hover:text-gray-700">
                    ✖
                </button>
                ...
                <p class="text-gray-600 mb-4">
                    ...
                    <strong>{{ downloadingVisa.first_name }}
                        {{ downloadingVisa.surname }}</strong>.
                </p>
                <button @click="generateVisaDocument"
                ...
                <div class="text-lg text-gray-700">
                    ...
                    <div class="mb-8">
                        ...
                        <ul class="list-disc pl-5 mb-4">
                            ...
                            <li class="mb-2">
                                Website:
                                <a href="http://www.example.com" class="text-blue-600">www.example.com</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="mb-8">
                        ...
                        <ul class="list-disc pl-5 mb-4">
                            <li class="mb-2">
                                Email:
                                <a href="mailto:support@example.com" class="text-blue-600">support@example.com</a>
                            </li>
                            <li class="mb-2">Phone: +123-456-7890</li>
                            <li class="mb-2">
...
export default {
    ...
    methods: {
        ...
        contactSupport(visitor) {
            const email = 'sakeenazayn@gmail.com';
            const subject = encodeURIComponent(`Support needed for ${visitor.first_name}`);
            const body = encodeURIComponent(`Hello, I need assistance regarding the application of ${visitor.first_name}.`);
