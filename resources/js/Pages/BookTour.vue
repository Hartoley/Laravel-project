<template>
    <Header></Header>
    <div class="bg-blue-500 mt-[10vh] py-[15vh] px-[5vw] text-white">
        <div
            v-for="(tour, index) in tourDetails"
            :key="index"
            class="w-[100%] bg-white h-[120vh] flex"
        >
            ...
            <div class="w-[35%] text-black">
                <div
                    class="w-[100%] h-[10%] text-white flex px-5 flex-col bg-blue-900"
                >
                ...
                <div class="flex flex-col gap-4 w-full px-5 py-5">
                    <div class="flex space-x-4">
                        <input
                            ...
                            class="border border-gray-400 px-4 py-2 rounded-md w-full"
                        />
                        <input
                            v-model="surname"
                            type="text"
                    ...
                    <input
                        ...
                        type="text"
                        readonly
                        placeholder="Name Of Tour You Are Booking*"
                        class="border border-gray-400 px-4 py-2 rounded-md"
                    />
                    <textarea
                        v-model="instructions"
                        placeholder="Additional Instructions"
                        class="border border-gray-400 px-4 py-2 rounded-md resize-none"
                        rows="4"
                    ></textarea>
                    <button
                        @click="bookTour"
...
export default {
    ...
    methods: {
        ...
        bookTour() {
            ...
            axios
                .post(route("travelPlan.create"), travelPlan)
                .then((res) => {
                    console.log(travelPlan);
                    console.log(res);
                    alert("Success");
                    window.location.href = `/makePayment/${this.tourName}/${res.data.id}`;
                })
                .catch((err) => {
                    alert("Failed");
                    console.log(err);
