        ...
        <div class="w-[70%] absolute flex items-center top-[12vh] h-[85%]">
          ...
          <div class="w-[50%] h-full rounded-br-md rounded-tr-md bg-[rgba(59,83,145,0.96)] flex flex-col">
            ...
            <div class="grid w-full h-[auto] place-items-center">
              <img class="w-[3vw]" src="https://i.pinimg.com/474x/c2/45/31/c245311698a8e4801bc402c592714e92.jpg" alt="" />
            </div>
            <div class="w-[100%] flex flex-col items-center justify-center text-white gap-5 h-[80%]">
              <input type="text" v-model="first_name" class="w-[70%] border-b-white border-l-[rgba(59,83,145,0.96)] border-r-[rgba(59,83,145,0.96)] border-t-[rgba(59,83,145,0.96)] placeholder-white outline-none bg-[rgba(59,83,145,0.96)] text-white" placeholder="FIRST NAME" />
              <input type="text" v-model="surname" class="w-[70%] border-b-white border-l-[rgba(59,83,145,0.96)] border-r-[rgba(59,83,145,0.96)] border-t-[rgba(59,83,145,0.96)] placeholder-white outline-none bg-[rgba(59,83,145,0.96)] text-white" placeholder="LAST NAME" />
              ...
              <button @click="signup" class="w-[60%] h-[10%] rounded-[25px] rounded-bl-[20px] text-white bg-[rgb(46,61,84)] hover:bg-[rgb(169,196,219)] transition duration-100">Sign up</button>
            </div>
          </div>
        </div>
      </div>
  ...
  export default {
    ...
    data() {
      return {
        ...
        password: '',
        showPassword: false, 
        image: { src: 'https://i.pinimg.com/474x/1f/90/01/1f9001b701284c5e51f7caa614b1fdaa.jpg', alt: 'Picture 1' },
        images: { src: 'https://i.pinimg.com/474x/ab/2e/ab/ab2eab9c2bee1c3890f7525d7ef698dc.jpg', alt: 'Picture 2' }
      };
    },
    methods: {
      togglePassword() {
